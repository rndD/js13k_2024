...
export const WEAPONS: IWEAPONS = {
  [WeaponType.Gun]: {
    ...
    // green
    c: rgb(0, 1, 0),
    d: ["MachineGun.js", "auto aim", "trata-ta-ta", "knockback on hit"],
    1: [2, 15, 1.3, 0.15, , , ,],
    2: [3, 16, 2, 0.12, , , ,],
    3: [5, 17, 3.8, 0.1, , , ,],
  },
  [WeaponType.Spikes]: {
    ...
    // blue dark
    c: rgb(0, 0, 1),
    d: ["Spikes.js", "area dmg", "only horizontal", "only ground enemies"],
    1: [3, 15, 10, 4, , , 2.5],
    2: [5, 15, 18, 3.5, , , 3.5],
    3: [8, 15, 24, 3, , , 4.5],
  },
  [WeaponType.Mortar]: {
    ...
    // red
    c: rgb(1, 0, 0),
    d: ["Mortar.js", "auto aim", "area damage", "fire dmg over time"],
  ...
  [WeaponType.Field]: {
    ...
    // purple
    c: rgb(0.5, 0, 0.5),
    d: ["ForceField.js", "area damage around you"],
    1: [3, 4, 2, 5, 2, , 4],
    2: [5, 4, 2.5, 4.5, 3, , 4.5],
    3: [6, 4, 3, 3, 3.5, , 5],
  },
  ...
  [WeaponType.CrossLaser]: {
    ...
    // yellow
    c: rgb(1, 1, 0),
    d: ["CrossLaser.js", "laser damage", "horizontal and vertical"],
